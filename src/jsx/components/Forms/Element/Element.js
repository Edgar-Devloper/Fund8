              ...
              <div className="basic-form">
                <form onSubmit={(e) => e.preventDefault()}>
                  <div className="form-group mb-0">
                    <div className="form-check">
                      <input className="form-check-input" type="radio"   name="optiongroup1" id="122" />
                      <label className="form-check-label" htmlFor="122">
                        Option 1
                      </label>
                    </div>
                    <div className="form-check">
                      <input className="form-check-input" type="radio"  name="optiongroup1" id="123" />
                      <label className="form-check-label" htmlFor="123">
                        Option 2
                      </label>
                    </div>
                    <div className="form-check disabled">
                      <input className="form-check-input" type="radio" name="optiongroup1" id="124" disabled/>
                      <label className="form-check-label" htmlFor="124">
                        Option 3
                      </label>
                    </div>
                  </div>
              ...
              <div className="basic-form">
                <form onSubmit={(e) => e.preventDefault()}>
                  <div className="form-group mb-0 d-flex align-items-center">
                      ...
                      <div className="form-check">
                        <input className="form-check-input" type="radio" name="optiongroup2" id="224" />
